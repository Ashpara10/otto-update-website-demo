        ...
        {open && (
          ...
          >
            {(() => {
              ...
              return (
                <div
                  className={`grid rounded-2xl border border-light-dark bg-dark text-heading shadow-[0_24px_60px_-20px_rgba(0,0,0,0.1)] overflow-hidden ${containerWidth}`}
                >
                  {group.feature && (
                    <Link
                      href={group.feature.cta.href}
                      onClick={() => setOpen(false)}
                      className="relative flex flex-col gap-3 border-r border-light-dark bg-light-dark/30 p-4 transition"
                    >
                      <span className="grid h-20 w-full place-items-center rounded-xl border border-light-dark bg-dark text-heading/70 text-sm font-semibold tracking-tight">
                        Otto × {group.label}
                      </span>
                      ...
                      <div className="px-2 space-y-2 mt-4">
                        ...
                        <span className="justify-self-end inline-flex items-center gap-1 text-xs font-semibold text-brand">
                  ...
                  >
                    {group.items.map((item) => (
                      <motion.li key={item.href} variants={itemAnim}>
                        ...
                        >
                          <span className="mt-0.5 grid size-10 shrink-0 place-items-center rounded-lg border border-light-dark bg-light-dark/40 text-foreground/80 group-hover:border-brand-soft/30 group-hover:bg-brand-soft/15 group-hover:text-brand transition">
