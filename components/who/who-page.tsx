      ...
      <main>
        ...
        <section className="relative py-20 lg:py-28">
          <div className="mx-auto max-w-4xl px-6 md:px-10 text-center">
            ...
            <h1 className="mt-4 text-2xl md:text-3xl font-semibold tracking-tight text-neutral-100">
              {headline}
              <br />
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <BookDemoButton className="inline-flex h-12 items-center justify-center rounded-full bg-brand px-6 text-base font-semibold text-neutral-900 transition hover:bg-brand-soft">
                Book a Demo
              </BookDemoButton>
            </div>
          </div>
        ...
        <section className="bg-dark px-5 py-16 sm:px-8 sm:py-20 border-t border-light-dark">
          <div className="mx-auto max-w-4xl">
            ...
            <h2 className="mt-3 text-2xl md:text-3xl font-semibold tracking-tight text-neutral-100">
              {beforeIntro}
            </h2>
            ...
            <ul className="mt-8 space-y-3">
              {beforeItems.map((line) => (
                <li
                  key={line}
                  className="flex items-start gap-3 rounded-xl border border-rose-500/20 bg-rose-500/[0.04] px-5 py-3 text-base leading-relaxed text-neutral-200"
                >
